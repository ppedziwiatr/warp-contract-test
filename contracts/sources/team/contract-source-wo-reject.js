...
var PLAYER_REGISTRY_CONTRACT_ID = "<PLAYER REGISTRY PLACEHOLDER>";
var GAME_CURRENCY_CONTRACT_ID = "<GAME CURRENCY PLACEHOLDER>";
...
async function handle(state, action) {
  ...
  if (input.function === "allow") {
    ...
    if (balances[caller] < quantity || !balances[caller] || balances[caller] == void 0 || balances[caller] == null || isNaN(balances[caller])) {
      throw new ContractError("team - Caller balance not high enough to make a balance of " + quantity + " claimable.");
    }
